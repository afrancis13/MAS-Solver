...
class SimulatedAnnealingTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.initial_ordering_input_nonplanar_one = [i for i in range(len(self.matrix_input_nonplanar_one))]
        self.initial_ordering_input_nonplanar_two = [i for i in range(len(self.matrix_input_nonplanar_two))]
    ...
    def test_simulated_annealing(self):
        ...
        observed_output_foster = \
            SimulatedAnnealingSolver(self.initial_ordering_foster, self.matrix_foster).maximum_acyclic_subgraph()
        self.assertEquals(observed_output_foster, expected_output_foster)

        expected_output_input_one = []
        observed_output_input_one = \
            SimulatedAnnealingSolver(self.initial_ordering_input_one, self.matrix_input_one).maximum_acyclic_subgraph()
        self.assertEquals(observed_output_input_one, expected_output_input_one)

        expected_ouput_input_cycle = []
        observed_output_input_cycle = \
            SimulatedAnnealingSolver(self.initial_ordering_input_cycle, self.matrix_input_cycle).maximum_acyclic_subgraph()
        ...
        observed_output_nonplanar_one = \
            SimulatedAnnealingSolver(self.initial_ordering_input_nonplanar_one, self.matrix_input_nonplanar_one).maximum_acyclic_subgraph()
        ...
        observed_output_nonplanar_two = \
            SimulatedAnnealingSolver(self.initial_ordering_input_nonplanar_two, self.matrix_input_nonplanar_two).maximum_acyclic_subgraph()
        self.assertEquals(observed_output_nonplanar_two, expected_output_nonplanar_two)

        expected_output_gray = []
        observed_output_gray = \
            SimulatedAnnealingSolver(self.initial_ordering_input_gray, self.matrix_input_gray).maximum_acyclic_subgraph()
